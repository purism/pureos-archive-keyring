README for the pureos-archive-keyring package
=============================================

Introduction
------------

The PureOS project signs its Release files that are stored on the
PureOS ftp-server and its mirrors with the key contained in this
packages.
